...
public class EditDoctorAccount extends AppCompatActivity {
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(EditDoctorAccount.this, ManageDoctors.class);
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(username.isEmpty()|| useremail.isEmpty()||pass.isEmpty()||fullname.isEmpty()
                        || phonenumber.isEmpty() )
                {
                    Toast.makeText(EditDoctorAccount.this,"There are empty fields",Toast.LENGTH_LONG).show();
