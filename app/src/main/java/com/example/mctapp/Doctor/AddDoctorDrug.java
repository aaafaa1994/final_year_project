...
public class AddDoctorDrug extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_doctor_drug);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(AddDoctorDrug.this, DoctorDrugActivity.class);
        ...
        time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TimePickerDialog timePickerDialog = new TimePickerDialog(AddDoctorDrug.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(d_name.isEmpty() || d_does.isEmpty()  || d_time.isEmpty()){
                    Toast.makeText(AddDoctorDrug.this, "Please Enter All Fields", Toast.LENGTH_SHORT).show();
                }else{
    ...
    public void add_drug() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLs.ROOT_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("query", "add_doctor_drug");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_account) {
            Intent intent = new Intent(AddDoctorDrug.this, DoctorProfile.class);
            startActivity(intent);
        } else if (id == R.id.nav_home) {
            Intent intent = new Intent(AddDoctorDrug.this, MainDoctorActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_Contact) {
            Intent intent = new Intent(AddDoctorDrug.this, DoctorContactActivity.class);
            startActivity(intent);
        }  else if (id == R.id.nav_logout) {
            Intent intent = new Intent(AddDoctorDrug.this, MainActivity.class);
            startActivity(intent);
        }
