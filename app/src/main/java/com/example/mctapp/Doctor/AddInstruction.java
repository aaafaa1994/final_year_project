...
public class AddInstruction extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ImageView back;
    EditText age,desc;
    Button reset,add;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(AddInstruction.this, DoctorInstructionActivity.class);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(i_desc.isEmpty() || i_age.isEmpty()){
                    Toast.makeText(AddInstruction.this, "Please Enter All Fields", Toast.LENGTH_SHORT).show();
                }else{
                    add_instruction();
                }
            }
    ...
    public void add_instruction() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLs.ROOT_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("query", "add_instruction");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_account) {
            Intent intent = new Intent(AddInstruction.this, DoctorProfile.class);
            startActivity(intent);
        } else if (id == R.id.nav_home) {
            Intent intent = new Intent(AddInstruction.this, MainDoctorActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_Contact) {
            Intent intent = new Intent(AddInstruction.this, DoctorContactActivity.class);
            startActivity(intent);
        }  else if (id == R.id.nav_logout) {
            Intent intent = new Intent(AddInstruction.this, MainActivity.class);
            startActivity(intent);
        }
