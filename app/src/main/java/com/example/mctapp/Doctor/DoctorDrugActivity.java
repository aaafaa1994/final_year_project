...
public class DoctorDrugActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ImageView back;
    RecyclerView r1;
    FloatingActionButton add;

    DoctorDrugAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor_drug);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(DoctorDrugActivity.this, MainDoctorActivity.class);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(DoctorDrugActivity.this, AddDoctorDrug.class);
                startActivity(intent);
            }
        });
        ...
        adapter = new DoctorDrugAdapter(this, drugs);
    ...
    public void getData(String rr){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLs.ROOT_URL,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObject.getBoolean("state")) {
                                ...
                                loading.dismiss();
                                Toast.makeText(DoctorDrugActivity.this,"No Drugs",Toast.LENGTH_LONG).show();
                            }
                        } catch (Exception ex) {
                            ex.printStackTrace();
                            loading.dismiss();
                            Toast.makeText(DoctorDrugActivity.this,"Error",Toast.LENGTH_LONG).show();
                        }
                    }
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("query", "get_doctor_drug");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_account) {
            Intent intent = new Intent(DoctorDrugActivity.this, DoctorProfile.class);
            startActivity(intent);
        } else if (id == R.id.nav_home) {
            Intent intent = new Intent(DoctorDrugActivity.this, MainDoctorActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_Contact) {
            Intent intent = new Intent(DoctorDrugActivity.this, DoctorContactActivity.class);
            startActivity(intent);
        }  else if (id == R.id.nav_logout) {
            Intent intent = new Intent(DoctorDrugActivity.this, MainActivity.class);
            startActivity(intent);
        }
