...
public class AddDrug extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(AddDrug.this, DrugActivity.class);
        ...
        time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TimePickerDialog timePickerDialog = new TimePickerDialog(AddDrug.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(d_name.isEmpty() || d_does.isEmpty()  || d_time.isEmpty()){
                    Toast.makeText(AddDrug.this, "Please Enter All Fields", Toast.LENGTH_SHORT).show();
                }else{

                    add_drug(d_name,d_does,d_time);
                }
            }
        });
    }
    public void add_drug(String n,String d,String t) {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_account) {
            Intent intent = new Intent(AddDrug.this, MotherProfile.class);
            startActivity(intent);
        } else if (id == R.id.nav_home) {
            Intent intent = new Intent(AddDrug.this, MainMotherActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_Contact) {
            Intent intent = new Intent(AddDrug.this, ContactActivity.class);
            startActivity(intent);
