...
public class ChildDetails extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ImageView back;
    RecyclerView r1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(ChildDetails.this,MainMotherActivity.class);
        ...
        adapter = new ChildAdapter(this, drugs);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObject.getBoolean("state")) {
                                ...
                                loading.dismiss();
                                Toast.makeText(ChildDetails.this,"No Child",Toast.LENGTH_LONG).show();
                            }
                        } catch (Exception ex) {
                            ex.printStackTrace();
                            loading.dismiss();
                            Toast.makeText(ChildDetails.this,"Error",Toast.LENGTH_LONG).show();
                        }
                    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_account) {
            Intent intent = new Intent(ChildDetails.this, MotherProfile.class);
            startActivity(intent);
        } else if (id == R.id.nav_home) {
            Intent intent = new Intent(ChildDetails.this, MainMotherActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_Contact) {
            Intent intent = new Intent(ChildDetails.this, ContactActivity.class);
            startActivity(intent);
        }  else if (id == R.id.nav_logout) {
            Intent intent = new Intent(ChildDetails.this, MainActivity.class);
            startActivity(intent);
        }
