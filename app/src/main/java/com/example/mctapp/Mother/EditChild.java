...
public class EditChild extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name.setText(sharedPreferenceManager.get_Child_name());
        age.setText(String.valueOf(sharedPreferenceManager.get_Child_age()));
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(EditChild.this, ChildDetails.class);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(d_name.isEmpty() || d_does.isEmpty()  ){
                    Toast.makeText(EditChild.this, "Please Enter All Fields", Toast.LENGTH_SHORT).show();
                }else{
    ...
    public void add_drug() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLs.ROOT_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("query", "edit_Child");
                params.put("name", name.getText().toString());
                params.put("age", age.getText().toString());
                params.put("child_id", String.valueOf(sharedPreferenceManager.get_Child_id()));
                return params;
            }
        };
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_account) {
            Intent intent = new Intent(EditChild.this, MotherProfile.class);
            startActivity(intent);
        } else if (id == R.id.nav_home) {
            Intent intent = new Intent(EditChild.this, MainMotherActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_Contact) {
            Intent intent = new Intent(EditChild.this, ContactActivity.class);
            startActivity(intent);
        }  else if (id == R.id.nav_logout) {
            Intent intent = new Intent(EditChild.this, MainActivity.class);
            startActivity(intent);
        }
