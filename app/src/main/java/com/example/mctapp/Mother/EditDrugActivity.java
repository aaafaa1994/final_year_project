...
public class EditDrugActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(EditDrugActivity.this, DrugActivity.class);
        ...
        time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TimePickerDialog timePickerDialog = new TimePickerDialog(EditDrugActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        alert.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                intent.putExtra(AlarmClock.EXTRA_MESSAGE,name.getText().toString());
                startActivity(intent);
            }
        });
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(d_name.isEmpty() || d_does.isEmpty()  || d_time.isEmpty()){
                    Toast.makeText(EditDrugActivity.this, "Please Enter All Fields", Toast.LENGTH_SHORT).show();
                }else{
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_account) {
            Intent intent = new Intent(EditDrugActivity.this, MotherProfile.class);
            startActivity(intent);
        } else if (id == R.id.nav_home) {
            Intent intent = new Intent(EditDrugActivity.this, MainMotherActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_Contact) {
            Intent intent = new Intent(EditDrugActivity.this, ContactActivity.class);
            startActivity(intent);
        }  else if (id == R.id.nav_logout) {
            Intent intent = new Intent(EditDrugActivity.this, MainActivity.class);
            startActivity(intent);
        }
